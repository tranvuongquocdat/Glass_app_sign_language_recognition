...
class _SignUpPageWidgetState extends State<SignUpPageWidget>
  ...
  void initState() {
    ...
    _model.signUpConfitmTextController ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.signUpConfitmFocusNode ??= FocusNode();
                              ...
                              children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .signUpConfitmTextController,
                                                focusNode: _model
                                                    .signUpConfitmFocusNode,
                                                autofocus: false,
                                                obscureText: !_model
                                                    .signUpConfitmVisibility,
                                                decoration: InputDecoration(
                                                  isDense: true,
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                  ...
                                                  suffixIcon: InkWell(
                                                    ...
                                                    focusNode: FocusNode(
                                                        skipTraversal: true),
                                                    child: Icon(
                                                      _model.signUpConfitmVisibility
                                                          ? Icons
                                                              .visibility_outlined
                                                          : Icons
                                                              .visibility_off_outlined,
                                                ...
                                                cursorColor:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                                validator: _model
                                                    .signUpConfitmTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ].divide(SizedBox(height: 12.0)),
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (_model.signInPassTextController.text !=
                                        _model
