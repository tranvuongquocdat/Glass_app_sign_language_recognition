...
import '/pages/abou_us/abou_us_widget.dart';
...
const debugRouteLinkMap = {
  '/homePage':
      'https://app.flutterflow.io/project/chattest-fwf3ic?tab=uiBuilder&page=HomePage',
  '/enterServerIPAddressPage':
      'https://app.flutterflow.io/project/chattest-fwf3ic?tab=uiBuilder&page=enterServerIPAddressPage',
  '/FPSenterServerIPAddressPage':
      'https://app.flutterflow.io/project/chattest-fwf3ic?tab=uiBuilder&page=FPSenterServerIPAddressPage',
  '/chatPage':
  ...
  '/FPSchatrecordVideoPage':
      'https://app.flutterflow.io/project/chattest-fwf3ic?tab=uiBuilder&page=FPSchatrecordVideoPage',
};
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'enterServerIPAddressPage',
          path: '/enterServerIPAddressPage',
          builder: (context, params) => EnterServerIPAddressPageWidget(),
        ),
        FFRoute(
          name: 'FPSenterServerIPAddressPage',
          path: '/FPSenterServerIPAddressPage',
          builder: (context, params) => FPSEnterServerIPAddressPageWidget(),
        ),
        FFRoute(
          name: 'chatPage',
          path: '/chatPage',
        ...
        FFRoute(
          name: 'FPSchatPage',
          path: '/FPSchatPage',
          builder: (context, params) => FPSChatPageWidget(
            serverResponse: params.getParam(
              'serverResponse',
              ParamType.String,
            ),
        ...
        FFRoute(
          ...
          path: '/signlanguageVideo',
          builder: (context, params) => SignlanguageVideoWidget(),
        ),
        FFRoute(
          name: 'SignInPage',
          path: '/signInPage',
        ...
        FFRoute(
          name: 'testSpeakToText',
          path: '/testSpeakToText',
        ...
        FFRoute(
          name: 'FPSchatrecordVideoPage',
          path: '/FPSchatrecordVideoPage',
          builder: (context, params) => FPSChatrecordVideoPageWidget(
            chatHistory: params.getParam<String>(
              'chatHistory',
              ParamType.String,
              isList: true,
        ...
        FFRoute(
          name: 'abou_us',
          path: '/abou-us',
          builder: (context, params) => AbouUsWidget(),
        )
