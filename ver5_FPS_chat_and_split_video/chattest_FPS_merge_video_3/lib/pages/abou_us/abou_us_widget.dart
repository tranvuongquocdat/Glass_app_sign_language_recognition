...
class LanguageStrings {
  static Map<String, Map<String, String>> content = {
    'vi': {
      ...
      'director': 'Project Director: Trần Vương Quốc Đạt',
      'overview_title': 'Tổng quan',
      'overview_content': 'DPSA là một ứng dụng di động được phát triển bằng Flutter, tích hợp AI để hỗ trợ giao tiếp thủ ngữ. Ứng dụng cung cấp các tính năng chuyển đổi giữa ngôn ngữ ký hiệu, văn bản và giọng nói.',
      'tech_stack_title': 'Công nghệ sử dụng',
      'frontend_title': 'Frontend:',
      'frontend_content': '• Flutter Framework\n• Firebase Authentication\n• Firebase Storage\n• Cloud Firestore\n• Camera Plugin\n• Google Generative AI (Gemini)\n• Text-to-Speech\n• HTTP Client',
      'backend_title': 'Backend:',
      'backend_content': '• Firebase Backend\n• Custom Python Server (port 8000)\n• Gemini API',
      'auth_title': 'Xác thực người dùng:',
      'auth_content': '• Email/Password\n• Google\n• Apple\n• Github\n• Anonymous\n• Phone number',
      'system_requirements': 'Yêu cầu hệ thống:',
      'system_requirements_content': '• Android 5.0 trở lên\n• iOS 11.0 trở lên\n• Camera\n• Microphone\n• Kết nối internet\n• Dung lượng trống > 100MB',
      'future_development': 'Phát triển tương lai:',
      'future_development_content': '• Thêm các ngôn ngữ mới\n• Cải thiện độ chính xác AI\n• Tích hợp real-time translation\n• Mở rộng thư viện thủ ngữ\n• Tích hợp học tập thủ ngữ',
    ...
    'en': {
      ...
      'director': 'Project Director: Tran Vuong Quoc Dat',
      'overview_title': 'Overview',
      'overview_content': 'DPSA is a mobile application developed with Flutter, integrating AI to support sign language communication. The app provides features for converting between sign language, text, and speech.',
      ...
      'system_requirements_content': '• Android 5.0 or higher\n• iOS 11.0 or higher\n• Camera\n• Microphone\n• Internet connection\n• Free storage > 100MB',
      'future_development': 'Future Development:',
      'future_development_content': '• Add new languages\n• Improve AI accuracy\n• Integrate real-time translation\n• Expand sign language library\n• Integrate sign language learning',
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 32),
                          _buildSection(
                            title: getText('overview_title'),
                            content: getText('overview_content'),
                            context: context,
                          ),
                          SizedBox(height: 32),
                          Text(
                          ...
                          SizedBox(height: 24),
                          _buildSection(
                            title: getText('tech_stack_title'),
                            content: '',
                            context: context,
                          ),
                          _buildFeatureSection(
                            title: getText('frontend_title'),
                            items: [getText('frontend_content')],
                            context: context,
                          ),
                          _buildFeatureSection(
                            title: getText('backend_title'),
                            items: [getText('backend_content')],
                            context: context,
                          ),
                          _buildFeatureSection(
                            title: getText('auth_title'),
                            items: [getText('auth_content')],
                            context: context,
                          ),
                          Divider(height: 32),
                          _buildSection(
                            title: getText('system_requirements'),
                            content: getText('system_requirements_content'),
                            context: context,
                          ),
                          SizedBox(height: 24),
                          _buildSection(
                            title: getText('future_development'),
                            content: getText('future_development_content'),
                            context: context,
                          ),
                        ],
                      ),
