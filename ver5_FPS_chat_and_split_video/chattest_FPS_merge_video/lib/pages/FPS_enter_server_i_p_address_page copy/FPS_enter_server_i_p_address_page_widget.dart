...
import 'FPS_enter_server_i_p_address_page_model.dart';
import 'package:http/http.dart' as http;
export 'FPS_enter_server_i_p_address_page_model.dart';

class FPSEnterServerIPAddressPageWidget extends StatefulWidget {
  const FPSEnterServerIPAddressPageWidget({super.key});

  @override
  State<FPSEnterServerIPAddressPageWidget> createState() =>
      _FPSEnterServerIPAddressPageWidgetState();
}

class _FPSEnterServerIPAddressPageWidgetState
    extends State<FPSEnterServerIPAddressPageWidget> with RouteAware {
  late FPSEnterServerIPAddressPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FPSEnterServerIPAddressPageModel());
