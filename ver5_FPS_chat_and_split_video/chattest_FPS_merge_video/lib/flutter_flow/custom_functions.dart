...
String getRelativeVideo(String text) {
  ...
  // Check in Vietnamese videos first
  if (VideoConstants._vietnameseVideos.containsKey(normalizedText)) {
    return 'assets/SLR_video/vietnamese/${VideoConstants._vietnameseVideos[normalizedText]}.gif';
  }
  
  // Then check English videos
  if (VideoConstants._englishVideos.containsKey(normalizedText)) {
    return 'assets/SLR_video/english/${VideoConstants._englishVideos[normalizedText]}.gif';
  }

  // Finally check Hmong videos
  if (VideoConstants._hmongVideos.containsKey(normalizedText)) {
    return 'assets/SLR_video/vietnamese/${VideoConstants._hmongVideos[normalizedText]}.gif';
  }

  // Return a default video if no match found
  return 'assets/SLR_video/default.gif';
}
